...
public class Task3 {
	public static void main(String[] args) {
		...
		int countaccgroup = acc2.groups.length;

///Task3
		System.out.println(countaccgroup == 0 ? "nhan vien nay chua co phong ban"
				: "phong ban cua nhan vien nay la: " + acc2.departmentid.name);
